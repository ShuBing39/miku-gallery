                ...
                <div class="member-list">
                  <div v-for="m in members" :key="m.id" class="member-item">
                    <div class="mem-info">
                      ...
                      <span class="uid">{{ m.username }} <span v-if="m.user_id === myCircle.owner_id">👑</span></span>
                    </div>
            ...
            <div class="right-col">
              <div class="panel project-section">
                <div class="panel-header with-btn">
                  <h4>📋 社团企划板</h4>
                  <button v-if="canManageProject" @click="$router.push('/submit-project')" class="btn-add-proj">+ 发布企划</button>
                </div>
